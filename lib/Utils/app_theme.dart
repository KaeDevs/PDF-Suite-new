...
class AppTheme {
  // ============================================
  // LIGHT MODE COLORS (Red & White Theme)
  // ============================================
  static const Color lightPrimary = Color(0xFFDC143C); // Crimson Red - Primary actions
  static const Color lightSecondary = Color(0xFFFF6B6B); // Coral Red - Secondary elements
  static const Color lightAccent = Color(0xFFFF4757); // Bright Red - Highlights & accents
  static const Color lightBackground = Color(0xFFFFF5F5); // Soft White-tinted background
  ...
  static const Color lightOnSurface = Color(0xFF2C2C2C); // Dark gray text
  static const Color lightTertiary = Color(0xFFE74C3C); // Warm Red - Tertiary/Highlights

  // ============================================
  // DARK MODE COLORS (Red & Dark Theme)
  // ============================================
  static const Color darkPrimary = Color(0xFFB71C1C); // Deep Red - Primary actions
  static const Color darkSecondary = Color(0xFFE53935); // Vivid Red - Secondary elements
  static const Color darkAccent = Color(0xFFFF5252); // Light Red - Highlights & accents
  static const Color darkBackground = Color(0xFF1A0A0A); // Very Dark Red-tinted background
  static const Color darkSurface = Color(0xFF2D1515); // Elevated dark red surface
  static const Color darkOnPrimary = Color(0xFFFFFFFF); // White text on primary
  static const Color darkOnSurface = Color(0xFFFFE0E0); // Light pinkish text on surface
  static const Color darkTertiary = Color(0xFFFF6F6F); // Soft Red - Tertiary/Highlights
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      displayLarge: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: lightOnSurface, fontFamily: 'Poppins'),
      displayMedium: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: lightOnSurface, fontFamily: 'Poppins'),
      displaySmall: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: lightOnSurface, fontFamily: 'Poppins'),
      headlineMedium: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: lightOnSurface, fontFamily: 'Poppins'),
      titleLarge: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: lightOnSurface, fontFamily: 'Poppins'),
      bodyLarge: TextStyle(fontSize: 16, color: lightOnSurface, fontFamily: 'Poppins'),
      bodyMedium: TextStyle(fontSize: 14, color: lightOnSurface, fontFamily: 'Poppins'),
    ),
  );
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      displayLarge: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: darkOnSurface, fontFamily: 'Poppins'),
      displayMedium: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: darkOnSurface, fontFamily: 'Poppins'),
      displaySmall: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: darkOnSurface, fontFamily: 'Poppins'),
      headlineMedium: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: darkOnSurface, fontFamily: 'Poppins'),
      titleLarge: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: darkOnSurface, fontFamily: 'Poppins'),
      bodyLarge: TextStyle(fontSize: 16, color: darkOnSurface, fontFamily: 'Poppins'),
      bodyMedium: TextStyle(fontSize: 14, color: darkOnSurface, fontFamily: 'Poppins'),
    ),
  );
